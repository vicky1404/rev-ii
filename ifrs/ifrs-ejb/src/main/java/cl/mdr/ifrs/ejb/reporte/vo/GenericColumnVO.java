...
public class GenericColumnVO {
    
    public static final int INI_ATTR = 1;
    public static final int MAX_ATTR = 30;
    public static final String PREFIJO = "attr";
    ...
    public GenericColumnVO() {
        super();
    }
    
    public GenericColumnVO(Object attr1) {
        super();
        this.attr1 = attr1;
    }
