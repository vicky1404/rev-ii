...
public class EstructuraPorGrupoBackingBean extends AbstractBackingBean implements Serializable {
	...
	public void buscarEstructurasPorGrupoAction(ActionEvent event){     
        ...
        try {
            this.setGrillaCatalogoList(this.getCatalogoByGrupoList(super.getFacadeService().getCatalogoService().findCatalogoByFiltro(null, this.getTipoCuadroSelected(), new Grupo(this.getIdGrupoSelected()), null), 
