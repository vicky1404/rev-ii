...
public class CargadorEstructuraServiceBean implements CargadorEstructuraServiceLocal {
    ...
    public Grilla getGrillaByExcelLoader(final Grilla gridE, final InputStream loadedExcel,final Long idGrilla,final Long idFila)throws Exception, CargaGrillaExcelException {
        ...
        if(colsSize > cols){
            throw new CargaGrillaExcelException("La cantidad de columna de la grilla es menor al número de columnas del excel");
        } else if (colsSize < cols)
        {
                throw new CargaGrillaExcelException("La cantidad de columna de la grilla es mayor al número de columnas del excel");
            }
