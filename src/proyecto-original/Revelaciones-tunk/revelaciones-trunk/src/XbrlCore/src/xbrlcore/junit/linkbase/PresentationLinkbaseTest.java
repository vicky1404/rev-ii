...
public final class PresentationLinkbaseTest {
    ...
    public static void setUp() {
        try {
            ...
            prTaxonomy = TestHelper.getDTS("file://eq13830/taxonomias/2012-07-17/taxonomia-svs/eeff-y-notas/cl-cs_shell_2012-07-17.xsd");
            presentationLinkbase = prTaxonomy.getPresentationLinkbase();
        } catch (Exception ex) {
    ...
    public void getPresentationLinkaseElement() {
        ...
        PresentationLinkbaseElement presElementEssen =
            presentationLinkbase.getPresentationLinkbaseElement(elementEssen, "http://www.xbrl.org/2003/role/link");
        PresentationLinkbaseElement presElementWurst =
            presentationLinkbase.getPresentationLinkbaseElement(elementWurst);
        PresentationLinkbaseElement presElementProdukte =
            presentationLinkbase.getPresentationLinkbaseElement(elementProdukte);
        ...
        assertEquals("p-pr_Produkte", presElementEssen.getParentElement().getId());
    ...
    public void getPresentationLinkbaseElementList() {
        try {
            List<PresentationLinkbaseElement> presentationLinkbaseElementList =
                presentationLinkbase.getPresentationList(prTaxonomy.getTopTaxonomy().getName(),
            ...
            while (presentationLinkbaseElementListIterator.hasNext()) {
                ...
                switch (i) {
                case 0:
                    assertEquals("p-pr_Produkte", currElement.getConcept().getId());
                    break;
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    assertEquals("p-pr_Fleisch", currElement.getConcept().getId());
                    break;
                case 4:
                    assertEquals("p-pr_Getraenke", currElement.getConcept().getId());
                    break;
                case 5:
                ...
                case 7:
                    ...
                    break;
                case 8:
                    assertEquals("p-pr_Elektronik", currElement.getConcept().getId());
                    break;
                case 9:
                    assertEquals("p-pr_Computer", currElement.getConcept().getId());
                    break;
                case 10:
                    assertEquals("p-pr_Fernseher", currElement.getConcept().getId());
                }
                i++;
            }
        } catch (Exception ex) {
