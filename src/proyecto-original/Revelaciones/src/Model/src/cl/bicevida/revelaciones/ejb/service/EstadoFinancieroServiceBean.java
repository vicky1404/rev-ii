...
public class EstadoFinancieroServiceBean implements EstadoFinancieroServiceLocal {
    ...
    public void persistRelaccionEeff(Map<String, String[]> relacionMap, Long idPeriodo, Grilla grilla){
        ...
        while(i.hasNext()){
            ...
            StringTokenizer fecuToken = new StringTokenizer(valueKey[0]==null?"":valueKey[0], ";");
            StringTokenizer cuentaToken = new StringTokenizer(valueKey[1]==null?"":valueKey[1], ";");
            
            Celda celda = celdaMap.get(celdaKey);
            
            if(celda!=null){
                
                /*Elimina la relacion anterior */
                ...
                while(fecuToken.hasMoreTokens()){
                    ...
                    Long key = EeffUtil.getLongFromKeyStrFecu(token);
                    System.out.println("Insertando FECU :"+key);
                    if(!key.equals(0L)){
                ...
                while(cuentaToken.hasMoreTokens()){
                    ...
                    Long key = EeffUtil.getLongFromKeyStrFecu(token);
                    System.out.println("Insertando Cuenta : "+key);
                    if(!key.equals(0L)){
