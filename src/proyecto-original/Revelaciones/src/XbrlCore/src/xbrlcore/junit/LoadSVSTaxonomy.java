			...
			/*for(Concept concept : taxonomySet.getConcepts()){
                ...
                for(Map.Entry<String, List<PresentationLinkbaseElement>> entry : taxonomySet.getPresentationLinkbase().getLinkRoleToElementList().entrySet()) {
                    ...
                    for(PresentationLinkbaseElement linkbaseElement : entry.getValue()){                        
                        System.err.println(linkbaseElement.getConcept());
                        System.err.println(labelLinkbase.getLabel(linkbaseElement.getConcept(), "http://www.xbrl.org/2003/role/label"));
                        System.err.println(labelLinkbase.getLabel(linkbaseElement.getConcept(), "http://www.xbrl.org/2003/role/documentation"));
                    }
                }
