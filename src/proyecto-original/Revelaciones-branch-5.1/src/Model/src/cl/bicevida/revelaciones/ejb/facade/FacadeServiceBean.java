...
public class FacadeServiceBean implements FacadeServiceLocal{
    ...
    @EJB private TaxonomyMappingServiceLocal taxonomyMappingService;
    ...
    public TaxonomyMappingServiceLocal getTaxonomyMappingService() {
        return taxonomyMappingService;
    }
}
