...
insert into ifrs_menu_grupo values (23,	'GRP_ADMIN');
insert into ifrs_menu_grupo values (23, 'GRP_ROOT');
insert into ifrs_menu_grupo values (24,	'GRP_ADMIN');
insert into ifrs_menu_grupo values (24, 'GRP_ROOT');
insert into ifrs_menu_grupo values (25,	'GRP_ADMIN');
insert into ifrs_menu_grupo values (25, 'GRP_ROOT');
commit;
commit;