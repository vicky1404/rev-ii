...
public class MapeadorTaxonomiaRevelacionesBackingBean extends SoporteBackingBean implements Serializable {
    ...
    public void buscarTaxonomyAndGrilla(ActionEvent event){
        ...
        try {
            ...
            this.setMapping( super.getFacade().getTaxonomyMappingService().buildMappingByEstructura(estructura, this.getTaxonomyConceptList()) );
    ...
    public void guardarMapeo(ActionEvent event){
        try {
            super.getFacade().getTaxonomyMappingService().persistMappingTaxonomiaRevelacion(super.getFiltro().getXbrlTaxonomia(), this.getMapping());
