...
public final class XBRLInstanceTest {
    ...
    public static void setUp() {
        try {
            ...
            MultipleDimensionType mdt =
                new MultipleDimensionType(opTemplateTaxonomy.getConceptByID("t-op_BankingActivitiesDimension"),
                                          opTemplateTaxonomy.getConceptByID("d-ba_TotalBankingActivitiesSubjectBIA"));
            @SuppressWarnings("unused")
            MultipleDimensionType mdt2 =
                new MultipleDimensionType(opTemplateTaxonomy.getConceptByID("t-op_BankingActivitiesDimension"),
                                          opTemplateTaxonomy.getConceptByID("d-ba_TotalBankingActivitiesSubjectSTAAlternative"));
            MultipleDimensionType mdt4 =
                new MultipleDimensionType(opTemplateTaxonomy.getConceptByID("t-op_BusinessLinesDimension"),
                                          opTemplateTaxonomy.getConceptByID("d-bl_CorporateFinance"));
            mdt4.addPredecessorDimensionDomain(new SingleDimensionType(opTemplateTaxonomy.getConceptByID("t-op_BankingActivitiesDimension"),
                                                                       opTemplateTaxonomy.getConceptByID("d-ba_TotalBankingActivitiesSubjectSTA")));
    ...
    public void corepInstance() {
        ...
        try {
            InstanceFactory.get().createInstance(new File(PATH2 + "FW1_instance.xml"));
            InstanceValidator validtator = new InstanceValidator(new File(PATH2 + "FW1_instance.xml"));
    ...
    public void xbrlFact() {
        try {
            ...
            assertTrue(instance.getFact(year3Fact.getConcept(),
                                        ctx.getDimensionalInformation(GeneralConstants.DIM_SCENARIO),
                                        GeneralConstants.DIM_SCENARIO) != null);
            assertTrue(instance.getFact(capitalRequirementsFact.getConcept(), myMDT, GeneralConstants.DIM_SCENARIO) !=
                       null);
