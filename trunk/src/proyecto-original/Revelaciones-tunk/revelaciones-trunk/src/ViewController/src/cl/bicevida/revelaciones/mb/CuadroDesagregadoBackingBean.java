            ...
            if(estructuras.getTipoEstructura().getIdTipoEstructura().equals(TipoEstructura.ESTRUCTURA_TIPO_GRILLA)){
                try {
                    ...
                    if(valid)
                        ...
                        agregarWarnMessage("El cuadro "+ estructuras.getGrillaVO().getGrilla().getEstructura1().getOrden() + " presenta diferencias con respecto del valor del estado financiero");
