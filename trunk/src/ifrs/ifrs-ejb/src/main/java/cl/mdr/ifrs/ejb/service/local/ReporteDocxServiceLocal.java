...
public interface ReporteDocxServiceLocal {
    ...
    WordprocessingMLPackage createDOCX(List<ReportePrincipalVO> reportes, byte[] headerImage, String usuarioOid, String ipUsuario, String nombreArchivo, PeriodoEmpresa periodoEmpresa) throws Exception;
