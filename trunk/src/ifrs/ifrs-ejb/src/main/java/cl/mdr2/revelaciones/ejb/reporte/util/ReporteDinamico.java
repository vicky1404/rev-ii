    ...
    public JasperPrint getJasperPrint(ReportePrincipalVO reporte) throws Exception {
        ...
        for(Estructura estructura : reporte.getVersion().getEstructuraList()){
            ...
            if (estructura.getGrilla() != null) {
                ...
                esListaValida = true;
                drb.addConcatenatedReport(crearSubreporteTableNew(grilla.getTitulo(), grilla.getColumnaList(),
                                                                  reporte.getPropiedades()),
                                          new ClassicLayoutManager(), "lista_tabla" + estructura.getIdEstructura(),
            ...
            if (estructura.getHtml() != null) {
                ...
                drb.addConcatenatedReport(crearSubreporteTableNew(html.getTitulo(), columnas,
                                                                  reporte.getPropiedades()),
                                          new ClassicLayoutManager(), "lista_tabla" + estructura.getIdEstructura(),
                                          DJConstants.DATA_SOURCE_ORIGIN_PARAMETER,
                                          DJConstants.DATA_SOURCE_TYPE_COLLECTION, false);
            ...
            if (estructura.getTexto() != null) {
                ...
                List<Columna> columnas = new ArrayList<Columna>();
                Columna columna = new Columna();
                columna.setAncho(Integer.valueOf(texto.getTexto() == null ? 150 :
                                                 texto.getTexto().length()).longValue());
                columna.setTituloColumna("");
                columnas.add(columna);
                drb.addConcatenatedReport(crearSubreporteTableNew("", columnas, reporte.getPropiedades()),
                                          new ClassicLayoutManager(), "lista_tabla" + estructura.getIdEstructura(),
                                          DJConstants.DATA_SOURCE_ORIGIN_PARAMETER,
                                          DJConstants.DATA_SOURCE_TYPE_COLLECTION, false);
                params.put("lista_tabla" + estructura.getIdEstructura(), generics);
