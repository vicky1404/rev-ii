...
@RunWith(Suite.class)
@Suite.SuiteClasses({ 
		DTSFactoryTest.class, 
		ConceptTest.class,
		XBRLLinkbaseTest.class, 
		LabelLinkbaseTest.class,
		PresentationLinkbaseTest.class, 
		DefinitionLinkbaseTest.class,
		CalculationLinkbaseTest.class, 
		DTSExtendedLinkbaseTests.class,
		InvalidTaxonomyTest.class, 
		DimensionTest.class, 
		FactTest.class,
		XBRLInstanceTest.class, 
		MultipleDimensionTypeTest.class,
		XBRLInstanceFactoryTest.class, 
		InstanceTestTmp.class })
