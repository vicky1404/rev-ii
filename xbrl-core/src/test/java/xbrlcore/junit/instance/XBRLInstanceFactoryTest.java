...
public final class XBRLInstanceFactoryTest {
	...
	public static void setUp() {
		...
		try {
			...
			instance = instanceFactory.createInstance(new File(XBRLInstanceFactoryTest.class.getResource(PATH + "ai_MKR.xml").toURI()));
			typedInstance = instanceFactory.createInstance(new File(XBRLInstanceFactoryTest.class.getResource(PATH + "ai_MKR_COM.xml").toURI()));
		} catch (Exception ex) {
