...
public final class XBRLInstanceTest {
	...
	public void corepInstance() {
		...
		try {
			String pathname = PATH2 + "FW1_instance.xml";
			InstanceFactory.get().createInstance(new File(getClass().getResource(pathname).toURI()));
			InstanceValidator validtator = new InstanceValidator(new File(getClass().getResource(pathname).toURI()));
