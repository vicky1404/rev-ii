...
public final class DTSExtendedLinkbaseTests {
    ...
    public void prohibitedLink2() {
         ...
         * berschreibenden und den verbietenden Arc zwei Attribute eingefgt,
         * so dass sie nicht beachtet werden drften (nicht-XLink Attribute
         * mssten gleich sein). Im Taxonomie-Editor lsst sich das nicht mehr
         * fehlerfrei ffnen weil es nicht mehr gegen das Schema validiert, fr
