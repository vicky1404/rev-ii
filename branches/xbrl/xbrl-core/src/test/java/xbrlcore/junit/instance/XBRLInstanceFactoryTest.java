...
public final class XBRLInstanceFactoryTest {
	...
	public static void setUp() {
		...
		try {
			...
			String pathname1 = PATH + "ai_MKR.xml";
			instance = instanceFactory.createInstance(new File(XBRLInstanceFactoryTest.class.getResource(pathname1).toURI()));
			String pathname2 = PATH + "ai_MKR_COM.xml";
			typedInstance = instanceFactory.createInstance(new File(XBRLInstanceFactoryTest.class.getResource(pathname2).toURI()));
		} catch (Exception ex) {
